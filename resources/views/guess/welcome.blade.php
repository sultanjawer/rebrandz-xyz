...
<html lang="en">
	<head>
		...
		<link href="{{ asset('img/logo-icon.png') }}" rel="safari-pinned-tab.svg"
	...
	<body class="slides chain simplifiedMobile animated">
			...
			<div class="sections desktop">
				...
				<div class="right">
					<ul class="menu trim">
						...
						<li class="cropRight">
							<a
								href="http://instagram.com/designmodo"
								class="trimRight"
								target="_blank"
								><svg>
									<use
		...
		<section class="slide fade-6 kenBurns">
				...
				<div class="container">
					<div class="wrap">
						<div class="fix-12-12">
							...
							<div
								class="button play small white popupTrigger ae-2 fromCenter margin-top-6 margin-bottom-6"
								data-popup-id="9"
							>
								<svg>
									<use
							...
							<p class="ae-3">
								<span class="opacity-8"
									>Start Now:
									<b>Empower Your Business and Unlock Your Success</b> with
									us.</span
								>
							</p>
							<form class="slides-form" action="" autocomplete="off">
								...
								<button
									type="submit"
									class="button blue gradient ae-7 fromCenter"
									name="button"
								>
									Get Started
								</button>
			...
			<div class="background" style="background-image: url('{{ asset('img/background/img-09.jpg') }}')"></div>
		</section>
		...
		<section class="slide fade-6 kenBurns fromLeft">
					...
					<div class="wrap">
						<div class="fix-12-12">
							<div class="fix-7-12 left toRight">
								<h1 class="ae-1">
									Designing application, Crafting relationship
								</h1>
								<p class="ae-2">
									<span class="opacity-8">
										Let us leverage our expertise to build apps that keep your
										business thriving. Experience the wisdom of technology.
									</span>
								</p>
			...
			<div class="background" style="background-image: url('{{ asset('img/background/img-15.jpg') }}')"></div>
		</section>
		...
		<section class="slide fade-6 kenBurns fromRight">
					...
					<div class="wrap">
						<div class="fix-12-12">
							<div class="fix-6-12 left toLeft">
								<h1 class="ae-1">
									Transforming Ideas into Digital Realities: Embrace the Power
									of Expression.
								</h1>
								<p class="ae-2">
									<span class="opacity-8">
										Unlock the limitless potential of your ideas. We transform
										concepts into captivating digital realities, empowering you
										to express your vision and drive meaningful impact.
									</span>
								</p>
								<a class="button blue gradient crop ae-3">Get Started</a>
							</div>
			...
			<div class="background" style="background-image: url('{{ asset('img/background/img-14.jpg') }}')"></div>
		</section>
		...
		<section class="slide fade-6 kenBurns">
								...
								<li class="col-6-12 fromBottomLeft">
									...
									<div class="ae-3">
										<p class="opacity-8">
											...
											brilliant work is rejected by the client, for whatever
											dopey, arbitrary reason, there is often another amazing,
											absolutely brilliant solution possible.
										</p>
									</div>
									<ul class="flex">
										<li class="col-6-12 ae-3">
											<h3 class="margin-top-3">SIMEVI</h3>
											<p class="tiny opacity-6">
												Monitoring and Evaluation System for Indonesian
												Horticulture.
											</p>
										</li>
										<li class="col-6-12 ae-4">
											<h3 class="margin-top-3">SIMETHIRS</h3>
											<p class="tiny opacity-6">
												This system ensures the monitoring of mandatory planting
												and production for importers of horticultural products.
											</p>
										</li>
										<!-- <li class="col-6-12 ae-5">
											<h3 class="margin-top-3">Music Center</h3>
											<p class="tiny opacity-6">
												Unforgettable feelings through a quality music.
											</p>
										</li>
			...
			<div class="background"  style="background-image: url('{{ asset('img/background/img-89.jpg') }}')"></div>
		</section>
		...
		<section class="slide fade-6 kenBurns">
				...
				<div class="container">
					<div class="wrap">
						<div class="fix-7-12">
							...
							<ul
								class="grid grid-85 equal margin-top-5 ae-2 fromCenter"
								data-equal-collapse-width="767"
							>
								<li
									class="col-6-12 col-tablet-1-2 col-phablet-1-1 margin-bottom-2 ae-3"
								>
									<div class="pad" style="background: #f5fbfe">
										...
										<div class="ae-5">
											<h6 class="uppercase bold small opacity-4">
												Billed per Month
											</h6>
										</div>
										...
										<a
											href="#"
											class="button green gradient wide cropSides cropBottom ae-7"
											>Contact us Now</a
										>
									</div>
								</li>
								<li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-4">
									<div class="pad">
										...
										<a
											href="#"
											class="button blue gradient wide cropSides cropBottom ae-8"
											>Contact Us</a
										>
									</div>
								</li>
			...
			<div class="background"  style="background-image: url('{{ asset('img/background/img-85.jpg') }}')" ></div>
		</section>
					...
					<div class="wrap">
						<div class="fix-6-12">
							...
							<p class="hero ae-2 margin-bottom-3">
								<span class="opacity-8">Learning never exhausts the mind.</span>
							</p>
							...
							<a href="#" class="button hollow ae-5" >
								<img src="{{asset('img/appstore.jpg')}}" height="63" />
							</a>
							<a href="#" class="button hollow ae-6" >
								<img src="{{asset('img/googleplay.jpg')}}" height="63"/>
							</a>
						</div>
					</div>
				</div>
			</div>
			<div class="background" style="background-image: url('{{ asset('img/background/img-95.jpg') }}')" ></div>
		</section>
